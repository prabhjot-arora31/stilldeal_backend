...
const sendLoginSuccess = async (email) => {
  const mailOptions = {
    from: "Still Deal <stilldealofficial@zohomail.in>",
    to: email,
    subject: "Still Deal Login Success",
    html: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Still Deal Login Success</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p>We are pleased to inform you that your login to Still Deal was successful.</p>
        
        <p>If you did not attempt to log in, please contact us immediately.</p>
